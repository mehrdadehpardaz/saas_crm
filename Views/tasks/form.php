...
<div class="tf-header">
    <h2><?= $is_edit ? '✏️ ویرایش فرصت فروش' : '➕ فرصت فروش جدید' ?></h2>
...
<form method="POST" action="index.php?page=tasks&action=<?= $is_edit ? 'update&id='.$id : 'create' ?>" class="tf-form">
    ...
    <div class="tf-actions">
        ...
        <button type="submit" class="tf-btn-submit"><?= $is_edit ? '💾 بروزرسانی' : '✅ ایجاد فرصت فروش' ?></button>
