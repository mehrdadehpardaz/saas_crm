...
<?php if ($message === 'created'): ?>
    <div class="tv-alert tv-alert-success">فرصت فروش با موفقیت ایجاد شد.</div>
<?php elseif ($message === 'completed'): ?>
    <div class="tv-alert tv-alert-success">فرصت فروش تکمیل شد.</div>
<?php elseif ($message === 'sold'): ?>
    <div class="tv-alert tv-alert-success">فرصت فروش با موفقیت منجر به فروش ثبت شد.</div>
<?php elseif ($message === 'cancelled'): ?>
    <div class="tv-alert tv-alert-warning">فرصت فروش کنسل شد.</div>
<?php elseif ($message === 'assigned'): ?>
    <div class="tv-alert tv-alert-success">فرصت فروش با موفقیت به کاربر جدید منتقل شد.</div>
...
<div class="tv-header">
    ...
    <div class="tv-actions">
        ...
        <?php endif; ?>
        <?php endif; ?>
        <a href="index.php?page=tasks&action=edit&id=<?= $task['id'] ?>" class="tv-btn tv-btn-edit" aria-label="ویرایش فرصت فروش">✏️</a>
...
<div class="tv-activity-card">
    <div class="tv-activity-hd">
        <h3>فعالیت‌های این فرصت فروش</h3>
        <span class="tv-activity-count"><?= count($activities) ?></span>
    </div>

    <?php if (empty($activities)): ?>
        <div class="tv-empty">
            <p>هنوز فعالیتی برای این فرصت فروش ثبت نشده.</p>
