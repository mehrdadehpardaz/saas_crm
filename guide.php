...
<meta name="description" content="راهنمای قدم‌به‌قدم پیگیر: چطور مشتری بسازی، فرصت فروش تعریف کنی، فعالیت ثبت کنی، تیم بسازی و گزارش بگیری.">
...
<header class="nav">
  <div class="nav-inner">
    ...
    <nav class="nav-links">
      <a href="#start">شروع</a>
      <a href="#flow">مشتری→فرصت فروش→فعالیت</a>
...
<section class="gd-hero">
  <div class="container">
    ...
    <div class="gd-checklist reveal">
      ...
      <a href="#flow" class="gd-check-item"><span class="gd-check-num">۳</span>فرصت فروش تعریف کن</a>
  ...
  <div class="container">
    ...
    <div class="flow-grid reveal">
      ...
      <div class="flow-card step-2">
        ...
        <div class="flow-icon" aria-hidden="true">✅</div>
        <h3>براش یک فرصت فروش بذار</h3>
        <p>از داخل صفحه مشتری → «فرصت فروش جدید». فرصت فروش یعنی یک هدف مشخص که دنبالش می‌کنی — نه یک کار روزمره. برای هر مشتری می‌تونی چند فرصت فروش همزمان داشته باشی.</p>
      ...
      <div class="flow-card step-3">
        ...
        <p>از داخل صفحه فرصت فروش → «افزودن فعالیت». هر تماس، جلسه، ایمیل یا یادداشت رو زیر همون فرصت فروش بنویس — تا وقتی فرصت فروش به نتیجه برسه.</p>
        <div class="flow-example"><b>مثال:</b> «تماس گرفتم، قیمت رو خواستن» — نوع: تماس</div>
      </div>
    </div>

    <div class="flow-note reveal">
      💡 <b>چرا این ترتیب مهمه؟</b> بدون مشتری، فرصت فروشی وجود نداره. بدون فرصت فروش، فعالیت‌هات پراکنده می‌مونن و معلوم نیست به کجا ختم میشن.
      وقتی فرصت فروش با نتیجه «✅ تکمیل شد»، «💰 منجر به فروش شد» یا «❌ کنسل شد» بسته میشه، از لیست فرصت‌های فروشِ فعال (و از داشبورد) خارج می‌شه — ولی همه فعالیت‌های زیرش برای گزارش‌گیری باقی می‌مونه.
    </div>
  </div>
</section>
    ...
    <div class="tr-grid">
      <div class="tr-card reveal">
        ...
        <ul class="tr-list">
          ...
          <li>وقتی کاربری غیرفعال میشه، مشتری‌ها و فرصت‌های فروشش پیش شرکت می‌مونن، فقط خودش دیگه وارد نمی‌شه</li>
        </ul>
      </div>
    ...
    <div class="tr-grid">
      <div class="tr-card reveal">
        ...
        <ul class="tr-list">
          ...
          <li>نرخ تکمیل فرصت‌های فروش و تعداد فروش‌های موفق</li>
        </ul>
      </div>
  ...
  <div class="container">
    ...
    <div class="bk-grid reveal">
      <div class="bk-card">
        ...
        <h3>خروجی اکسل</h3>
        <p>یک فایل با ۶ شیت جدا: کاربران، مشتریان، مخاطبین، فعالیت‌ها، فرصت‌های فروش و صنایع. محدود به داده‌های شرکت خودت — برای آرشیو یا ارائه به بیرون از سیستم.</p>
      </div>
      <div class="bk-card">
